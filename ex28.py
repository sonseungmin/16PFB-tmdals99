...
print(" 8. True or 1==1 = %s" % str((1 != 0) and (2 == 1)))
print(" 9. 'test' == 'testing' = %s" % str('test' == 'testing'))
print(" 10. 1!=0 and 2==1 = %s" % str('test' == 'testing'))
...
print(" 19. 'chunky'=='bacaon' and not (3==4 or 3==3) = %s" %(('chunky' == 'bacon') and not ((3 == 4) or (3 == 3))))
